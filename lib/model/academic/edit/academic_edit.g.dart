...
part of 'academic_edit.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AcademicEditModel _$AcademicEditModelFromJson(Map<String, dynamic> json) {
  return AcademicEditModel(
    academic_id: json['academic_id'] as String,
...
Map<String, dynamic> _$AcademicEditModelToJson(AcademicEditModel instance) =>
    <String, dynamic>{
